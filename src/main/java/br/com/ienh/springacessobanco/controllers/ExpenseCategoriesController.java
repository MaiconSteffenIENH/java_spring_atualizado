...
public class ExpenseCategoriesController {
    ...
    @GetMapping("/novo")
    public String novoForm(@ModelAttribute("expenseCategory") ExpenseCategoryDTO expenseCategory){
        return "/expense-categories/novoForm";
    }

    @PostMapping("/novo")
    public String novoSalvar(@Valid @ModelAttribute("expenseCategory") ExpenseCategoryDTO expenseCategory, BindingResult bindingResult){
        if(bindingResult.hasErrors()) return "/expense-categories/novoForm";
    ...
    public String editarForm(@PathVariable int id, Model model){
        model.addAttribute("expenseCategory", expenseCategoryService.obterExpenseCategoryPorId(id));
    ...
    public String editarSalvar(@Valid @ModelAttribute("expenseCategory") ExpenseCategoryDTO expenseCategory, BindingResult bindingResult){
        if(bindingResult.hasErrors()) return "/expense-categories/editarForm";
